...
export default function RiwayatKunjungan() {
  ...
  const getWeeksInMonth = () => {
    ...
    weekRanges.forEach((range) => {
      weeks.push(
        `Pekan ${range.week} ${currentMonth} (${range.start}-${range.end})`
      );
    });
    return weeks;
  };
  ...
  const filterByWeek = (data) => {
    ...
    return data.filter((visit) => {
      ...
      return (
        ...
        getWeekOfMonth(visit.tanggal) === weekNumber
      );
    });
  };
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full md:w-auto">
            ...
            <div className="relative w-full sm:w-auto">
              <button
                ...
                className="bg-white text-black border-2 border-solid border-black hover:border-black px-4 py-2 rounded-lg flex items-center text-sm transition-all duration-300 ease-in-out shadow-sm hover:shadow-md w-full"
              >
                ...
                {loading ? (
                  <tr>
                    <td colSpan="7" className="text-center p-6">
                      <div className="w-8 h-8 border-4 border-red-200 rounded-full animate-spin border-t-red-500 mx-auto"></div>
                    </td>
                  </tr>
                ) : error ? (
                  <tr>
